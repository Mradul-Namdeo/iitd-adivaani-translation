...
## ✨ Sample Translations (Model Output)
Here are three examples of successful Hindi-to-Marathi translations generated by the custom architecture:

| Hindi Input (Source) | Marathi Output (Model Prediction) |
| :--- | :--- |
| भारत एक महान देश है। | भारत हा एक महान देश आहे. |
| मैं आज बहुत खुश हूँ। | आज मला अतिशय आनंद होतो आहे. |
